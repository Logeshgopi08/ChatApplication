...
import backgroundImage from "../assets-project/assets/wallapaper.jpeg";
import { FaAngleLeft, FaTruckPlane } from "react-icons/fa6";
      ...
      <section className="h-16 bg-white flex items-center px-4">
        ...
        <form className="h-full w-full flex gap-2" onSubmit={handleSendMessage}>
          <input
            ...
            className="py-1 px-4 outline-none w-full h-full text-black"
            value={message.text}
